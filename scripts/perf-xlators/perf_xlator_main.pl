...
#------------------------------------------------------------------------------
# Objective : Automation of performance xlator Options test cases
...
#----------------------------
#Add the test suites relevant to this test
...
#------------------------------------------------------------------------------
# Function Name : perf_xlator_options_main 
# Description   : This the main function which calls other test cases
# Args          : None
# Return Value  : None
#------------------------------------------------------------------------------
sub perf_xlator_options_main {
    ...
    push( @hosts, new Host("10.70.37.86") );
